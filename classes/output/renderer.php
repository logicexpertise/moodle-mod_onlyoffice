 ...
 */
class mod_onlyoffice_renderer extends plugin_renderer_base {

    /**
     * Returns html to display the content of mod_folder
     * @param cm_info $cm course module object from onlyoffice_cm_info_view()/cm_info_dynamic()
     * @return string
     */
    public function display_onlyoffice(cm_info $cm) {
